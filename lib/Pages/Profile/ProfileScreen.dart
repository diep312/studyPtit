...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor:UsedColor.kThirdSecondaryColor,
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 30),
                const Divider(),
                ProfileMenuWidget(icon: Icons.book, onPressed: (){}, title: "Rules and disclaimer", textColor: Colors.brown,),
                ProfileMenuWidget(icon: Icons.logout, onPressed: (){
                  final authService = Provider.of<AuthService>(context, listen: false);
                  authService.signOut();
                }, title: "Sign out", textColor: Colors.brown,),
              ],
            ),
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Container(
        ...
        child: Icon(icon, color: UsedColor.kComplementColor,),
      ),
      title: Text(
          title,
        style: TextStyle(
